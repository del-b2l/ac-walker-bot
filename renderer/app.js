...
function addMessage(role, text) {
  ...
  const avatarClass = role === 'user' ? 'avatar' : 'avatar walker-av'
  const avatarInner = role === 'user' ? 'U' : ''
...
async function sendMessage() {
  ...
  if (result.error) {
    addMessage('assistant', "Wuh... something went wrong, arf. Check your .env file!")
  } else {
...
document.getElementById('walkerWrap').addEventListener('click', () => {
  if (!isTyping) {
